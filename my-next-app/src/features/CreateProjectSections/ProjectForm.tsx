...
// css
const formSpan = (cols: number) => clsx(`col-span-${cols}`, "flex flex-col gap-2 items-start justify-end mt-2");
...
return (
    <Sheet open={open} onClose={onClose}>
        {(onClose) => (
            <>
                <div className="shrink-0 w-full max-w-xl flex px-1 pt-1 pb-4 items-center gap-2 justify-start overflow-hidden">
                ...
                <section className={`w-full h-full  pb-20 px-1 flex items-start justify-start gap-5 ${scrollClass}`}>
                    <div className="max-w-xl w-full grid grid-cols-6 gap-2">
                    <div className={formSpan(4)}>
