export default function Head() {
    return (
      <>
        <title>Splitly – 有人邀請您加入！</title>
        <meta name="description" content="Splitly 幫助您與朋友同事快速分帳、記帳，支援多種分帳方式。" />
        <meta name="google" content="notranslate" />
        <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
  
        {/* Open Graph */}
        <meta property="og:title" content="Splitly – 您最佳的分帳工具" />
        <meta property="og:description" content="Splitly 幫助您與朋友同事快速分帳、記帳，支援多種分帳方式。" />
